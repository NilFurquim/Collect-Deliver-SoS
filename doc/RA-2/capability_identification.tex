...
\begin{tabular}{| r | p{2cm} | c | c |}
	...
	%& RR18 & Mapping \\
	FR10, FR14 & RR19 & Task & Support \\ % or Path Planning or Mapping or Localization 	\\
	\hline
...
\begin{tabular}{| l | p{6.6cm} | c | c |}
	...
	Mapping & No & No &\\
	Localization & No & No & yes\\ %(maybe too simple, join with mapping?, analyze scalability. Possible to create more complex localization?)
