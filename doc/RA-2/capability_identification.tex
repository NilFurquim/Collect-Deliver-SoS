...
%Capabilities 
%TODO: Refazer o diagrama, adicionar o communication, possivel conexão com localization(mas acho que não)
% ^- Communication adicionado no .draw
...
% \begin{tabular*}{\textwidth}{@{\extracolsep{\fill} } | r | l | l | c | }
% \begin{tabularx}{\textwidth}{>{\bfseries} | r | l | l | c |}
% \begin{tabularx}{\textwidth}{>{\bfseries} r|X|X|c}
		\hline
