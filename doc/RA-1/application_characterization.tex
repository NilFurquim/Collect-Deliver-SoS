...
\begin{enumerate}
	...
	\item Robots must be able h follow the guide lines of the grid. %RR15 %Navigation
	...
	\item Robots must be able to communicate with each other. %RR3??, RR11, RR21, RR26 %Control
	\item Robots must be able know the position of other robots. %RR3???, RR21, RR15, RR16 %Mapping
	\item Robots must be able to calculate shortest path using the dijkstra algorithm. %RR16 %Path Planning
	\item Robots must be able calculate the shortest path considering the posistion of other robots. %RR5, RR15??? %Path Planning %SEM DOMAIN CONCEPT
